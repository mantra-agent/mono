...
function Sidebar({
  ...
  const { isMobile, forceMobile, state, openMobile, setOpenMobile } = useSidebar()
        ...
        <>
          {openMobile && (
            <button
              ...
              className="absolute inset-0 top-[var(--top-bar-height,2.75rem)] z-40 bg-black/80"
          ...
          <div
            ...
            className={cn(
              "absolute top-[var(--top-bar-height,2.75rem)] bottom-0 z-50 flex w-[var(--sidebar-width)] flex-col bg-sidebar text-sidebar-foreground transition-transform duration-300 ease-in-out",
              side === "left"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed top-[var(--top-bar-height,2.75rem)] bottom-[var(--bottom-bar-height,0px)] z-10 hidden h-[calc(100svh-var(--top-bar-height,2.75rem)-var(--bottom-bar-height,0px))] w-[var(--sidebar-width)] transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover-elevate hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover-elevate data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:w-8! group-data-[collapsible=icon]:h-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
