...
import { Activity, AlertTriangle, Bug, CheckCircle2, Circle, CircleDot, Download, ExternalLink, Loader2, Play, RefreshCw, Smartphone, Upload, Wifi, XCircle } from "lucide-react";
