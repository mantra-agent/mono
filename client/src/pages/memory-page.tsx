      ...
      >
        ...
        <div className="flex-1 overflow-y-auto bg-background scrollbar-thin">
          <div className="space-y-1 p-2">
            {isLoading ? (
              <div className="flex items-center justify-center py-12" data-testid="journal-loading">
                                ...
                                {isSelected && (
                                  <div className="ml-6 mr-2 border-l border-border/40 pl-2 py-2 space-y-3" data-testid={`log-claim-expanded-${claim.id}`}>
                                    {selectedClaim ? (
                                      ...
                                      <div className="flex items-center justify-center py-6" data-testid="journal-claim-loading">
                                        <Loader2 className="h-5 w-5 animate-spin text-muted-foreground" />
                                      </div>
                                    ) : (
