...
function ProfileSummaryEditor({
  ...
  return (
    <div className="max-h-80 max-w-none overflow-auto rounded-xl rounded-bl-sm border border-primary/20 bg-card/70 px-3 py-2 text-[9px] leading-tight text-white scrollbar-thin">
      <Textarea
        value={draft}
