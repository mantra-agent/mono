                        ...
                        <div>
                          {editingNoteId === item.id ? (
                            <Textarea
                              ...
                              className="min-h-24 w-full resize-none border-0 bg-transparent p-0 text-[10px] leading-tight text-white shadow-none outline-none ring-0 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 md:text-[10px]"
                              data-testid={`textarea-note-log-${item.id}`}
                            />
                          ) : (
                            <button
                              type="button"
                              className="block w-full whitespace-pre-wrap text-left text-[10px] leading-tight text-white"
