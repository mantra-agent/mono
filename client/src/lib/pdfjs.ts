 ...
 * and one worker-backed path. Prefer the installed package when the bundler can
 * resolve it; otherwise fall back to the pinned CDN build of the same version.
 */
