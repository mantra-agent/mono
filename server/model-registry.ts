...
const REGISTRY: Record<string, ModelInfo> = {
  ...
  "gpt-5.6-terra": {
    ...
    name: "GPT-5.6 Terra",
    provider: "openai",
    cost: { input: 0.0000025, output: 0.000015, cacheRead: 0.00000025, cacheWrite: 0 },
    contextWindow: 1050000,
    maxOutputTokens: 128000,
    reasoning: false,
    thinking: { level: "none", description: "No visible thinking output" },
  ...
  "gpt-5.6-luna": {
    ...
    name: "GPT-5.6 Luna",
    provider: "openai",
    cost: { input: 0.000001, output: 0.000006, cacheRead: 0.0000001, cacheWrite: 0 },
    contextWindow: 1050000,
    maxOutputTokens: 128000,
    reasoning: false,
    thinking: { level: "none", description: "No visible thinking output" },
