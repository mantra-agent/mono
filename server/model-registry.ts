...
const REGISTRY: Record<string, ModelInfo> = {
  ...
  "gpt-5.6-luna": {
    ...
    maxOutputTokens: 128000,
    reasoning: false,
    thinking: { level: "none", description: "Fast, low-cost GPT-5.6 model for high-volume workloads" },
  },
  "gpt-5.5": {
    id: "gpt-5.5",
    name: "GPT-5.5",
  ...
  "gpt-5.6-luna-sub": {
    ...
    maxOutputTokens: 128000,
    reasoning: false,
    thinking: { level: "none", description: "Fast GPT-5.6 subscription model via Codex/Work access" },
    requiresSubscription: true,
