...
const REGISTRY: Record<string, ModelInfo> = {
  ...
  // openai-subscription models ride chatgpt.com Codex/Work. Effective window is 400k
  // (official GPT-5-Codex / GPT-5.3-Codex cards), not the 1.05M API family windows.
  "gpt-5.6-sol-sub": {
    id: "gpt-5.6-sol-sub",
...
export { supportsGrokReasoningEffort } from "@shared/model-connectors";
