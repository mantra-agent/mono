...
Work prerequisites live in one Core graph: the \`blocked_by\` relationship, read through the Work Dependencies projection in context (\`resolveWorkDependencyContext\`) and mutated only through \`blocking_graph\`.
