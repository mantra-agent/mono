...
export const TOOL_DETAILS: Record<string, ToolDetailEntry> = {
  ...
  tasks: {
    ...
    actions: {
      ...
      update: { description: "Update a task's properties — priority, status, owner, title, description, tags, deadline, etc.", optionalParams: ["taskId", "title", "newTitle", "description", "priority", "status", "impact", "effort", "owner", "requiresReview", "projectId", "milestoneId", "tags", "deliverable", "acceptanceCriteria", "context", "output", "deadline", "tokenEstimate"] },
    },
  },
  finance: {
