  ...
  library: {
    ...
    parameters: {
      ...
      properties: {
        ...
        parentId: { type: "string", description: "Parent page ID for explicit human-selected placement; semantic placement still records the decision" },
