      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            "get_budget", "add_budget_department", "rename_budget_department", "delete_budget_department", "add_budget_category", "rename_budget_category", "delete_budget_category", "add_budget_line_item", "rename_budget_line_item", "delete_budget_line_item", "set_budget_monthly_amount",
          ],
