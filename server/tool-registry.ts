  ...
  tasks: {
    ...
    parameters: {
      ...
      properties: {
        ...
        clearFields: { type: "array", items: { type: "string" }, description: "Fields to explicitly clear (set to null). Allowed: description, context, output, deadline, projectId, milestoneId. (for update)" },
