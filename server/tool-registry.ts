  ...
  business_plans: {
    ...
    parameters: {
      ...
      properties: {
        ...
        name: { type: "string", description: "Plan name (for create/rename)" },
        goalId: { type: "string", description: "Thematic Goal ID (for set_thematic_goal)" },
        projectId: { type: "number", description: "Initiative Project ID (for add/remove_initiative)" },
        kpiId: { type: "string", description: "KPI ID (for add/remove_kpi)" },
        vaultId: { type: "string", description: "Visible live Vault ID (for create/assign_vault)" },
      },
      required: ["action"],
    },
  },
