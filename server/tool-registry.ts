  ...
  platforms: {
    ...
    parameters: {
      ...
      properties: {
        ...
        featureId: { type: "string", description: "Feature UUID for get_feature, update_feature, archive_feature, delete_feature, link_feature_kpi, unlink_feature_kpi, list_feature_sessions" },
