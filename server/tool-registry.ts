      ...
      properties: {
        action: {
          ...
          enum: [
            ...
            "list_metrics", "get_metric", "create_metric", "update_metric", "delete_metric", "sample_usage", "list_samples", "record_sample", "delete_sample",
          ],
        ...
        start: { type: "string", description: "Inclusive ISO range start for sample_usage" },
        end: { type: "string", description: "Exclusive ISO range end for sample_usage; cannot be future or more than 400 days after start" },
