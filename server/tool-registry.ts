  ...
  people: {
    ...
    parameters: {
      ...
      properties: {
        ...
        relation: { type: "string", description: "Personal/family relationship (for create/update). Must be one of the predefined values (Mother, Father, Spouse, Cousin, etc.); custom relationships are rejected." },
        professionalRelations: { type: "array", items: { type: "string" }, description: "Professional relationships (for create/update). Choose from predefined values: Partner, Investor, Advisor, Colleague, Employee, Vendor. Customer can only be set by a person, not the Agent." },
        ...
        tags: { type: "array", items: { type: "string", description: "A tag label" }, description: "Cross-cutting tags (for create/update). Do not add tags that duplicate the person's company or role; such tags are automatically dropped." },
  ...
  tasks: {
    ...
    parameters: {
      ...
      properties: {
        ...
        clearFields: { type: "array", items: { type: "string" }, description: "Fields to explicitly clear (set to null). Allowed: description, assigneeSubjectType + assigneeSubjectId together, deadline, projectId, milestoneId. (for update)" },
