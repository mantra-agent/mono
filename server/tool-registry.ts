  ...
  health: {
    ...
    parameters: {
      ...
      properties: {
        ...
        estimatedMinutes: { type: "number", description: "Estimated time in minutes (create_activity, update_activity)" },
        estimatedCost: { type: "number", description: "Estimated cost in dollars (create_activity, update_activity)" },
        requirements: { type: "string", description: "Prerequisites or equipment needed (create_activity, update_activity)" },
