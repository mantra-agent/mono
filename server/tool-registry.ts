...
export const TOOLS: Record<string, ToolMeta> = {
  ...
  work: {
    ...
    parameters: {
      ...
      properties: {
        ...
        owner: { type: "string", description: "Owner: me, xyz" },
  ...
  tasks: {
    ...
    parameters: {
      ...
      properties: {
        ...
        tags: { type: "array", items: { type: "string" }, description: "Tags" },
        deliverable: { type: "string", description: "Expected output" },
  ...
  news: {
    ...
    parameters: {
      ...
      properties: {
        ...
        source_type: { type: "string", enum: ["channel_x", "channel_web", "x", "web", "x_account", "reddit", "rss", "subreddit", "rss_feed", "pinned_topic"], description: "Optional source type. For list_signals accepts channel or stored item types. For add/list/update sources use channel_x, channel_web, x_account, subreddit, rss_feed, pinned_topic." },
  ...
  introspection: {
    ...
    parameters: {
      type: "object",
      properties: {
        action: { type: "string", enum: ["list_skills", "get_skill", "list_inference_calls", "get_inference_call"], description: "list_skills: list all skills with name, category, activity, author. get_skill: get full skill details including process instructions, whenToUse, and the structured weighted checklist used by the scorer. list_inference_calls: list recent LLM calls with model, profile, cost, tokens. get_inference_call: get full details of a specific call including input/output." },
        id: { type: "string", description: "Skill name (for get_skill) or inference call ID (for get_inference_call)" },
        ...
        profile: { type: "string", description: "Filter inference calls by profile (e.g., 'myelination', 'chat')" },
...
export async function generateToolsMd(): Promise<string> {
  ...
  lines.push(
    ...
    "| Tool | Description |",
    "|------|-------------|",
    "| `add_priority` | Add a priority during SOD check-ins |",
