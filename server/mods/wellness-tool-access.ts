...
/** Tools whose discovery and invocation belong to the Wellness Mod. */
export const WELLNESS_TOOL_NAMES = new Set(["health"]);
...
export async function requireWellnessToolAccess(
  principal: Principal,
  toolName: string,
): Promise<void> {
