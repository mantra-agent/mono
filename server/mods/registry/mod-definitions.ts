...
const build: ModDefinition = {
  ...
  contributions: {
    ...
    skills: [
      ...
      skillRef("build.skill.issue-feature", "issue-feature"),
    ],
    timers: [
...
const business: ModDefinition = {
  ...
  version: "1.3.0",
  name: "Business",
  description: "Business operating surfaces: business model, Business Plan, budgets, roles, and hiring.",
  outcome: {
    ...
    activationSignals: ["business.route.business-model", "business.route.budgets"],
  },
...
const wellness: ModDefinition = {
  ...
  contributions: {
    ...
    navigation: [
      nav("wellness.nav.habits", "Wellness", "Habits", "CalendarCheck", "navigation.habits.open", "wellness.route.habits", 1),
      ...
      nav("wellness.nav.health", "Wellness", "Health", "HeartPulse", "navigation.health.open", "wellness.route.health", 4),
    ],
