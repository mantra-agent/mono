...
export const coreDefinition: CoreDefinition = {
  ...
  contributions: {
    ...
    navigation: [
      ...
      // System
      nav("core.nav.performance", "System", "Performance", "Gauge", "navigation.performance.open", "core.route.system", 1, { requiredPermissions: ["system:read"] }),
      ...
      nav("core.nav.context", "System", "Context", "BrainCircuit", "navigation.context.open", "core.route.brain", 6),
