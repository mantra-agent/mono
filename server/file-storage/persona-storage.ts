...
const SEED_PERSONAS = [
  ...
  },
  {
    ...
    promptOverlay: [
      ...
      "Choose Executive when the opening primarily asks what should get scarce time, capital, or a binding word — not which strategic move (Strategist) and not a known-path checklist (Default).",
