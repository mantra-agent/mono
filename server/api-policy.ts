...
const PUBLIC_RULES: ApiPolicyRule[] = [
  ...
  { classification: "public", exact: ["/api/auth/login", "/api/auth/logout", "/api/auth/setup", "/api/auth/register", "/api/auth/reset", "/api/auth/forgot-password"], reason: "authentication and setup flow" },
...
const ADMIN_RULES: ApiPolicyRule[] = [
  { classification: "admin", prefixes: ["/api/admin", "/api/backup", "/api/backups", "/api/db-sync", "/api/schema", "/api/logs", "/api/events", "/api/tool-stats", "/api/secrets", "/api/diag", "/api/diagnostics", "/api/workspace", "/api/railway", "/api/expo", "/api/integrations/github", "/api/gitnexus", "/api/gitnexus-status", "/api/encryption", "/api/performance", "/api/gateway", "/api/models", "/api/routers", "/api/maintenance", "/api/mobile", "/api/setup", "/api/server", "/api/boot-info", "/api/config", "/api/design-doc", "/api/trust-config", "/api/openai-subscription", "/api/grok-subscription", "/api/claude-cli", "/api/elevenlabs", "/api/integrations/expo", "/api/integrations/automation-auth", "/api/platforms", "/api/provider-connections", "/api/prompt-modules", "/api/communications", "/api/notifications", "/api/auth/users", "/api/auth/identity-graph", "/api/auth/meeting-join-policy", "/api/auth/dev-login", "/api/dev"], reason: "system administration route" },
  // Narrow residual /api/settings/* admin surface. Account timezone is personal (see PERSONAL_RULES).
  { classification: "admin", exact: ["/api/settings/inference-debug"], reason: "system administration route" },
  { classification: "admin", prefixes: ["/api/auth/invite"], reason: "user administration route" },
  {
...
const PERSONAL_RULES: ApiPolicyRule[] = [
  { classification: "personal", exact: ["/api/settings/timezone", "/api/client-logs", "/api/browser-telemetry", "/api/browser-telemetry/summary"], reason: "authenticated personal account settings and bounded client diagnostics" },
