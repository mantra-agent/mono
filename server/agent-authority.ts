...
function requiresPermission(
  ...
  if (toolName === "business" && (action === "get_budget" || action === "get_model" || action === "get_pricing" || action === "get_hiring_plan" || action === "list_hiring_slots")) return "system:read";
  if (toolName === "business" && (action?.includes("_budget_") || action === "update_package" || action === "update_extras" || action === "set_assumption" || action === "link_assumption_kpi" || action === "clear_assumption_kpi")) return "system:write";
