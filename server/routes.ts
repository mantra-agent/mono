...
import { registerBusinessPricingRoutes } from "./business-pricing-routes";
...
import { registerDocumentTemplateRoutes } from "./document-template-routes";
...
import { registerBlockingGraphRoutes } from "./blocking-graph-routes";
...
export async function registerRoutes(
  ...
  registerBusinessPricingRoutes(app);
  ...
  registerBlockingGraphRoutes(app);
