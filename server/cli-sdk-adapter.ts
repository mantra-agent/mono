      ...
      async (args: Record<string, unknown>) => {
        ...
        try {
          ...
          toolResultQueue.push({
            ...
            historicalProviderResult: result.historicalProviderResult,
            canMateriallyShrinkOnRefresh: result.canMateriallyShrinkOnRefresh,
            refreshReductionTokens: result.refreshReductionTokens,
            error: result.error,
