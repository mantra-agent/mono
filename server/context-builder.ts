...
const TOOL_SHORT_DESCRIPTIONS: Record<string, string> = {
  ...
  gmail: "Read, search, create, and update persisted email drafts via Gmail. The human sends via the draft widget's Send button. Actions: status, search, read, draft, update_draft, recent, download_attachment.",
