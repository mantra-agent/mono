...
const SIDE_EFFECT_TIERS: Record<string, { default: SideEffectTier; actions?: Record<string, SideEffectTier> }> = {
  ...
  business: { default: 1, actions: { list_hiring_slots: 0, create_hiring_slot: 2, update_hiring_slot: 2, cancel_hiring_slot: 2, list: 0, get: 0, list_kpis: 0, get_kpi: 0, list_metrics: 0, get_metric: 0, sample_range: 0, sample_usage: 0, list_samples: 0, list_businesses: 0, get_business: 0, list_business_vaults: 0, get_budget: 0, delete_budget_department: 2, delete_budget_category: 2, delete_budget_line_item: 2, create_business: 2, update_business: 2, archive_business: 2, add_business_vault: 2, remove_business_vault: 2, set_business_vaults: 2 } },
  ...
  issues: { default: 1, actions: { list: 0, list_reported: 0, get: 0 } },
