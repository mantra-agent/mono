...
/** Additive, replay-safe schema for canonical incremental conversation history. */
export async function ensureConversationSchema(pool: Pick<Pool, "query">): Promise<void> {
  await pool.query(`
