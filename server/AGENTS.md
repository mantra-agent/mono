...
- **4 legacy tiers:** communication, realtime, request, and background remain caller-facing priority/liveness labels. Communication, realtime, and request map to `interactive_agent`; background maps to `background_agent`.
