...
2. Extend the existing `system` tool with paginated `list_issues` and bounded `update_issue`; preserve `get_issue` and ordinary Issue storage as the source of truth.
