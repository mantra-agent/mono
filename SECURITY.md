...
| SEC-SUP-R3 | High | The read-only root lockfile audit reports 3 critical and 18 high advisories, including protobufjs, simple-git, tar, Drizzle, Axios, ws, Multer, Hono, fast-uri, lodash, linkify-it, minimatch, and form-data. Remediation/reachability proof is now owned by @task:1138 and the added First-Class Security dependency-cure plan step; this application/platform step does not mislabel those supply-chain findings as closed. | Engineering | July 20, 2026 |
