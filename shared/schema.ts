...
export const billingMeterDeliveries = pgTable("billing_meter_deliveries", {
  ...
  identifierUnique: uniqueIndex("uq_billing_meter_deliveries_identifier").on(table.stripeIdentifier),
...
export const workflowStagePersonaSchema = z.enum(["Engineer", "Architect"]);
...
export const workflowStageDefinitionSchema = z.object({
  ...
  persona: workflowStagePersonaSchema.default("Engineer"),
