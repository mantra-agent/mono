...
export const UI_INTERACTION_TARGET_ROUTES = {
  ...
  "navigation.kpis.open": { href: "/business/kpis", permission: "system:read", description: "Track the KPIs that matter." },
  "navigation.metrics.open": { href: "/business/metrics", permission: "system:read", description: "Watch your business metrics." },
  ...
  "navigation.performance.open": { href: "/system?tab=resources", permission: "system:read", description: "Watch system performance and resources." },
