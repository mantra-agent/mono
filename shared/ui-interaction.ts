...
export const UI_INTERACTION_TARGET_ROUTES = {
  ...
  "navigation.habits.open": { href: "/habits", description: "Track your habits and wellness rhythms." },
  "navigation.reflections.open": { href: "/reflections", description: "Write and review your reflections." },
  "navigation.gratitude.open": { href: "/gratitude", description: "Capture what you are grateful for." },
  "navigation.wellness.open": { href: "/habits", description: "Track your habits and wellness rhythms." },
  ...
  "navigation.kpis.open": { href: "/tools/kpis", description: "Track the KPIs that matter." },
  "navigation.metrics.open": { href: "/tools/metrics", description: "Watch your business metrics." },
