...
export const METRIC_PRODUCER_PICKER_ITEMS: readonly MetricProducerPickerItem[] = [
  ...
  { key: "mantra-meetings", label: "Meetings", family: "product" },
  { key: "net-promoter-score", label: "Net Promoter Score", family: "product" },
  { key: "activation-rate", label: "Activation Rate", family: "product" },
  { key: "monthly-account-churn", label: "Monthly Logo Churn", family: "product" },
