...
export const REFERENCE_REGISTRY: Readonly<Record<KnownReferenceType, ReferenceTypeDefinition>> = {
  ...
  workflow: definition("workflow", "opaque", OPAQUE_PATTERN),
  workflow_gate: definition("workflow_gate", "integer", INTEGER_PATTERN),
  ...
  feature: definition("feature", "uuid", UUID_PATTERN, { route: id => `/build/features/${encodeURIComponent(id)}` }),
