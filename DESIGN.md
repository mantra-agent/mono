...
- The hierarchy tree panel is always vertical. On mobile it takes the full display. On web it is a full-width vertical tree on the canvas. Do not reserve an empty right third that clips row content.
